...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...PendingReceivedDocumentPaymentsListItem_payment_terms.fields(`${keyPrefix}payment_terms`, isInput),
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'payment_terms': utils.removeIfEmpty(PendingReceivedDocumentPaymentsListItem_payment_terms.mapping(bundle, `${keyPrefix}payment_terms`)),
