...
module.exports = {
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      limits: utils.removeIfEmpty(
        CompanyInfo_plan_info_limits.mapping(bundle, `${keyPrefix}limits`)
      ),
      functions: utils.removeIfEmpty(
        CompanyInfo_plan_info_functions.mapping(bundle, `${keyPrefix}functions`)
      ),
      functions_status: utils.removeIfEmpty(
        CompanyInfo_plan_info_functions_status.mapping(bundle, `${keyPrefix}functions_status`)
      ),
    };
  },
};
