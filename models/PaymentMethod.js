...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      ...PaymentAccount.fields(`${keyPrefix}default_payment_account`, isInput),
      {
        ...
        children: PaymentMethodDetails.fields(
          `${keyPrefix}details${!isInput ? '[]' : ''}`,
          isInput,
          true
        ),
      },
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      default_payment_account: utils.removeIfEmpty(
        PaymentAccount.mapping(bundle, `${keyPrefix}default_payment_account`)
      ),
      details: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}details`],
        `${keyPrefix}details`,
