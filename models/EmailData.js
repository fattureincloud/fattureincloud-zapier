...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      ...EmailData_default_sender_email.fields(`${keyPrefix}default_sender_email`, isInput),
      {
        ...
        children: SenderEmail.fields(
          `${keyPrefix}sender_emails_list${!isInput ? '[]' : ''}`,
          isInput,
          true
        ),
      },
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      default_sender_email: utils.removeIfEmpty(
        EmailData_default_sender_email.mapping(bundle, `${keyPrefix}default_sender_email`)
      ),
      sender_emails_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}sender_emails_list`],
        `${keyPrefix}sender_emails_list`,
        SenderEmail
      ),
