...
module.exports = {
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      default_payment_method: utils.removeIfEmpty(
        PaymentMethod.mapping(bundle, `${keyPrefix}default_payment_method`)
      ),
      ...
      intent_declaration_protocol_number:
        bundle.inputData?.[`${keyPrefix}intent_declaration_protocol_number`],
      intent_declaration_protocol_date:
        bundle.inputData?.[`${keyPrefix}intent_declaration_protocol_date`],
