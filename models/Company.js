...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      },
      {
        ...
        children: ControlledCompany.fields(
          `${keyPrefix}controlled_companies${!isInput ? '[]' : ''}`,
          isInput,
          true
        ),
      },
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      controlled_companies: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}controlled_companies`],
        `${keyPrefix}controlled_companies`,
        ControlledCompany
      ),
