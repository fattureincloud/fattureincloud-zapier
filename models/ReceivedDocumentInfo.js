...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      ...ReceivedDocumentInfo_items_default_values.fields(
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      default_values: utils.removeIfEmpty(
        ReceivedDocumentInfo_default_values.mapping(bundle, `${keyPrefix}default_values`)
      ),
      items_default_values: utils.removeIfEmpty(
        ReceivedDocumentInfo_items_default_values.mapping(
          bundle,
          `${keyPrefix}items_default_values`
        )
      ),
