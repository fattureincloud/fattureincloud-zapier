...
module.exports = {
  fields: (prefix = "", isInput = true, isArrayChild = false) => {
    const { keyPrefix, labelPrefix } = utils.buildKeyAndLabel(
      prefix,
      isInput,
      isArrayChild,
    );
    return [
      ...
      ...IssuedDocumentPreCreateInfo_default_values.fields(
        `${keyPrefix}default_values`,
        isInput,
      ),
      ...IssuedDocumentPreCreateInfo_extra_data_default_values.fields(
        `${keyPrefix}extra_data_default_values`,
        isInput,
      ),
      ...IssuedDocumentPreCreateInfo_items_default_values.fields(
        `${keyPrefix}items_default_values`,
        isInput,
      ),
      {
      ...
      },
      {
        ...
        children: Currency.fields(
          `${keyPrefix}currencies_list${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
      {
        ...
        children: DocumentTemplate.fields(
          `${keyPrefix}templates_list${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
      {
        ...
        children: DocumentTemplate.fields(
          `${keyPrefix}dn_templates_list${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
      {
        ...
        children: DocumentTemplate.fields(
          `${keyPrefix}ai_templates_list${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
      ...
      },
      {
        ...
        children: Language.fields(
          `${keyPrefix}languages_list${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
      {
        ...
        children: PriceList.fields(
          `${keyPrefix}price_lists${!isInput ? "[]" : ""}`,
          isInput,
          true,
        ),
      },
  ...
  mapping: (bundle, prefix = "") => {
    ...
    return {
      ...
      default_values: utils.removeIfEmpty(
        IssuedDocumentPreCreateInfo_default_values.mapping(
          bundle,
          `${keyPrefix}default_values`,
        ),
      ),
      extra_data_default_values: utils.removeIfEmpty(
        IssuedDocumentPreCreateInfo_extra_data_default_values.mapping(
          bundle,
          `${keyPrefix}extra_data_default_values`,
        ),
      ),
      items_default_values: utils.removeIfEmpty(
        IssuedDocumentPreCreateInfo_items_default_values.mapping(
          bundle,
          `${keyPrefix}items_default_values`,
        ),
      ),
      countries_list: bundle.inputData?.[`${keyPrefix}countries_list`],
      currencies_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}currencies_list`],
        `${keyPrefix}currencies_list`,
        Currency,
      ),
      templates_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}templates_list`],
        `${keyPrefix}templates_list`,
        DocumentTemplate,
      ),
      dn_templates_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}dn_templates_list`],
        `${keyPrefix}dn_templates_list`,
        DocumentTemplate,
      ),
      ai_templates_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}ai_templates_list`],
        `${keyPrefix}ai_templates_list`,
        DocumentTemplate,
      ),
      ...
      languages_list: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}languages_list`],
        `${keyPrefix}languages_list`,
        Language,
      ),
