...
module.exports = {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'templates_list': utils.removeKeyPrefixes(bundle.inputData?.[`${keyPrefix}templates_list`], `${keyPrefix}templates_list`),
            'dn_templates_list': utils.removeKeyPrefixes(bundle.inputData?.[`${keyPrefix}dn_templates_list`], `${keyPrefix}dn_templates_list`),
            'ai_templates_list': utils.removeKeyPrefixes(bundle.inputData?.[`${keyPrefix}ai_templates_list`], `${keyPrefix}ai_templates_list`),
            'payment_methods_list': utils.removeKeyPrefixes(bundle.inputData?.[`${keyPrefix}payment_methods_list`], `${keyPrefix}payment_methods_list`),
            ...
            'languages_list': utils.removeKeyPrefixes(bundle.inputData?.[`${keyPrefix}languages_list`], `${keyPrefix}languages_list`),
        }
    },
}
