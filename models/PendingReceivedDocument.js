...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      },
      {
        ...
        children: Attachment.fields(
          `${keyPrefix}other_attachments${!isInput ? '[]' : ''}`,
          isInput,
          true
        ),
      },
      ...
      },
      {
        ...
        children: PendingReceivedDocumentPaymentsListItem.fields(
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      other_attachments: utils.childMapping(
        bundle.inputData?.[`${keyPrefix}other_attachments`],
        `${keyPrefix}other_attachments`,
        Attachment
      ),
      ...
      extracted_data: utils.removeIfEmpty(
        PendingReceivedDocument_extracted_data.mapping(bundle, `${keyPrefix}extracted_data`)
      ),
    };
  },
};
