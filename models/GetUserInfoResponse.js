...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      ...GetUserInfoResponse_email_confirmation_state.fields(
        `${keyPrefix}email_confirmation_state`,
        isInput
      ),
    ];
  },
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      email_confirmation_state: utils.removeIfEmpty(
        GetUserInfoResponse_email_confirmation_state.mapping(
          bundle,
          `${keyPrefix}email_confirmation_state`
        )
      ),
