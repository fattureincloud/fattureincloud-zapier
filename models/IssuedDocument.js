...
module.exports = {
    fields: (prefix = '') => {
        ...
        return [
            {
                key: `${keyPrefix}id`,
                label: `Issued document id - [${keyPrefix}id]`,
                type: 'integer',
            },
            ...
            },
            {
                ...
                label: `Issued document number [If not specified, next number is used] - [${keyPrefix}number]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}numeration`,
                label: `Issued document numeration [Not available if type=delivery_note] - [${keyPrefix}numeration]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}date`,
                label: `Issued document date [defaults to today's date] - [${keyPrefix}date]`,
                type: 'datetime',
            },
            {
                key: `${keyPrefix}year`,
                label: `Issued document year - [${keyPrefix}year]`,
                type: 'integer',
            },
            ...
            },
            {
                ...
                label: `Issued document revenue center [or cost center if type=supplier_order]. - [${keyPrefix}rc_center]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}notes`,
            ...
            },
            {
                ...
                label: `Issued document \"Rivalsa INPS\" percentual value - [${keyPrefix}rivalsa]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}cassa`,
                label: `Issued document \"Cassa previdenziale\" percentual value - [${keyPrefix}cassa]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_cassa`,
                label: `[Read Only] Issued document cassa amount. - [${keyPrefix}amount_cassa]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}cassa_taxable`,
                label: `Issued document cassa taxable percentage - [${keyPrefix}cassa_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_cassa_taxable`,
                label: `[Can be set only if cassa_taxable is NULL] Issued document cassa taxable amount - [${keyPrefix}amount_cassa_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}cassa2`,
                label: `Issued document \"Cassa previdenziale 2\" percentual value - [${keyPrefix}cassa2]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_cassa2`,
                label: `[Read Only] Issued document cassa2 amount - [${keyPrefix}amount_cassa2]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}cassa2_taxable`,
                label: `Issued document cassa2 taxable percentage - [${keyPrefix}cassa2_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_cassa2_taxable`,
                label: `[Can be set only if cassa2_taxable is NULL] Issued document cassa2 taxable amount - [${keyPrefix}amount_cassa2_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}global_cassa_taxable`,
                label: `Issued document global cassa taxable percentage - [${keyPrefix}global_cassa_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_global_cassa_taxable`,
                label: `[Can be set only if global_cassa_taxable is NULL] Issued document global cassa taxable amount - [${keyPrefix}amount_global_cassa_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}withholding_tax`,
                label: `Issued document withholding tax (ritenuta d'acconto) percentual value - [${keyPrefix}withholding_tax]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}withholding_tax_taxable`,
                label: `Issued document withholding tax taxable (imponibile) percentual value - [${keyPrefix}withholding_tax_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}other_withholding_tax`,
                label: `Issued document other withholding tax (altra ritenuta) percentual value - [${keyPrefix}other_withholding_tax]`,
                type: 'number',
            },
            {
            ...
            ...PaymentMethod(`${keyPrefix}payment_method`),
            {
                ...
                label: `Issued document uses split payment - [${keyPrefix}use_split_payment]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}use_gross_prices`,
                label: `Issued document uses gross prices - [${keyPrefix}use_gross_prices]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}e_invoice`,
                label: `Issued document is an e-invoice. - [${keyPrefix}e_invoice]`,
                type: 'boolean',
            },
            ...
            ...DocumentTemplate(`${keyPrefix}acc_inv_template`),
            {
                ...
                label: `Issued document PDF horizontal margins - [${keyPrefix}h_margins]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}v_margins`,
                label: `Issued document PDF vertical margins - [${keyPrefix}v_margins]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}show_payments`,
                label: `Show the expiration dates of the payments on the document - [${keyPrefix}show_payments]`,
                type: 'boolean',
            },
            {
            ...
            },
            {
                ...
                label: `Show paypal button in the PDF - [${keyPrefix}show_paypal_button]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}show_notification_button`,
                label: `Show notification button in the PDF - [${keyPrefix}show_notification_button]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}show_tspay_button`,
                label: `Show ts pay button in the PDF - [${keyPrefix}show_tspay_button]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}delivery_note`,
                label: `Issued document has delivery note - [${keyPrefix}delivery_note]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}accompanying_invoice`,
                label: `Issued document has an accompanying invoice - [${keyPrefix}accompanying_invoice]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}dn_number`,
                label: `Issued document attached delivery note number - [${keyPrefix}dn_number]`,
                type: 'integer',
            },
            {
                key: `${keyPrefix}dn_date`,
                label: `Issued document attached delivery note date - [${keyPrefix}dn_date]`,
                type: 'datetime',
            },
            {
                key: `${keyPrefix}dn_ai_packages_number`,
                label: `Issued document attached delivery note number of packages - [${keyPrefix}dn_ai_packages_number]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_ai_weight`,
                label: `Issued document attached delivery note package weight - [${keyPrefix}dn_ai_weight]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_ai_causal`,
                label: `Issued document attached delivery note causal - [${keyPrefix}dn_ai_causal]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_ai_destination`,
                label: `Issued document attached delivery note destination - [${keyPrefix}dn_ai_destination]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_ai_transporter`,
                label: `Issued document attached delivery note transporter - [${keyPrefix}dn_ai_transporter]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_ai_notes`,
                label: `Issued document attached delivery note notes - [${keyPrefix}dn_ai_notes]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}is_marked`,
                label: `Issued document is marked - [${keyPrefix}is_marked]`,
                type: 'boolean',
            },
            {
                key: `${keyPrefix}amount_net`,
                label: `[Read only] Issued document total net amount - [${keyPrefix}amount_net]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_vat`,
                label: `[Read Only] Issued document total vat amount - [${keyPrefix}amount_vat]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_gross`,
                label: `[Read Only] Issued document total gross amount - [${keyPrefix}amount_gross]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_due_discount`,
                label: `Issued document amount due discount - [${keyPrefix}amount_due_discount]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_rivalsa`,
                label: `[Read Only] Issued document rivalsa amount - [${keyPrefix}amount_rivalsa]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_rivalsa_taxable`,
                label: `Issued document taxable rivalsa amount - [${keyPrefix}amount_rivalsa_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_withholding_tax`,
                label: `[Read Only] Issued document withholding tax amount (ritenuta d'acconto). - [${keyPrefix}amount_withholding_tax]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_withholding_tax_taxable`,
                label: `Issued document taxable withholding tax amount - [${keyPrefix}amount_withholding_tax_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_other_withholding_tax`,
                label: `[Read Only] Issued document other withholding tax amount (altra ritenuta) - [${keyPrefix}amount_other_withholding_tax]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_other_withholding_tax_taxable`,
                label: `Issued document taxable other withholding tax amount - [${keyPrefix}amount_other_withholding_tax_taxable]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}amount_enasarco_taxable`,
                label: `Issued document taxable enasarco amount - [${keyPrefix}amount_enasarco_taxable]`,
                type: 'number',
            },
            ...IssuedDocument_extra_data(`${keyPrefix}extra_data`),
            {
                key: `${keyPrefix}seen_date`,
                label: `Issued document seen date - [${keyPrefix}seen_date]`,
                type: 'datetime',
            },
            {
                key: `${keyPrefix}next_due_date`,
                label: `Issued document date of the next not paid payment - [${keyPrefix}next_due_date]`,
                type: 'datetime',
            },
            {
                key: `${keyPrefix}url`,
                label: `[Temporary] [Read Only] Issued document url of the document PDF file - [${keyPrefix}url]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}dn_url`,
                label: `[Temporary] [Read Only] Issued document url of the attached delivery note PDF file - [${keyPrefix}dn_url]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}ai_url`,
                label: `[Temporary] [Read Only] Issued document url of the accompanying invoice PDF file - [${keyPrefix}ai_url]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}attachment_url`,
                label: `[Temporary] [Read Only] Issued document url of the attached file - [${keyPrefix}attachment_url]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}attachment_token`,
                label: `[Write Only] Issued document attachment token returned by POST /issued_documents/attachment - [${keyPrefix}attachment_token]`,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                label: `Issued document creation date - [${keyPrefix}created_at]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}updated_at`,
                label: `Issued document last update date - [${keyPrefix}updated_at]`,
                type: 'string',
            },
        ]
    },
