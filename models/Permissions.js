...
module.exports = {
  fields: (prefix = '', isInput = true, isArrayChild = false) => {
    ...
    return [
      ...
      ...Permissions_fic_issued_documents_detailed.fields(
        `${keyPrefix}fic_issued_documents_detailed`,
        isInput
      ),
    ];
  },
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      fic_issued_documents_detailed: utils.removeIfEmpty(
        Permissions_fic_issued_documents_detailed.mapping(
          bundle,
          `${keyPrefix}fic_issued_documents_detailed`
        )
      ),
