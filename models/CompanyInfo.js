...
module.exports = {
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      access_info: utils.removeIfEmpty(
        CompanyInfo_access_info.mapping(bundle, `${keyPrefix}access_info`)
      ),
      fic_license_expire: bundle.inputData?.[`${keyPrefix}fic_license_expire`],
      fic_plan_name: bundle.inputData?.[`${keyPrefix}fic_plan_name`],
      plan_info: utils.removeIfEmpty(
        CompanyInfo_plan_info.mapping(bundle, `${keyPrefix}plan_info`)
      ),
