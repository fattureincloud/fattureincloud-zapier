...
module.exports = {
  ...
  mapping: (bundle, prefix = '') => {
    ...
    return {
      ...
      payment_account_in: utils.removeIfEmpty(
        PaymentAccount.mapping(bundle, `${keyPrefix}payment_account_in`)
      ),
      amount_out: bundle.inputData?.[`${keyPrefix}amount_out`],
      payment_account_out: utils.removeIfEmpty(
        PaymentAccount.mapping(bundle, `${keyPrefix}payment_account_out`)
      ),
    };
  },
};
