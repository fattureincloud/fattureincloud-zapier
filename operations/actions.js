...
const actions = {
  ...
  [IssuedDocumentsApi.deleteIssuedDocumentAttachment.key]:
    IssuedDocumentsApi.deleteIssuedDocumentAttachment,
  ...
  [IssuedDocumentsApi.getExistingIssuedDocumentTotals.key]:
    IssuedDocumentsApi.getExistingIssuedDocumentTotals,
  [IssuedDocumentsApi.getIssuedDocument.key]: IssuedDocumentsApi.getIssuedDocument,
  [IssuedDocumentsApi.getIssuedDocumentPreCreateInfo.key]:
    IssuedDocumentsApi.getIssuedDocumentPreCreateInfo,
  [IssuedDocumentsApi.getNewIssuedDocumentTotals.key]:
    IssuedDocumentsApi.getNewIssuedDocumentTotals,
  ...
  [IssuedDocumentsApi.uploadIssuedDocumentAttachment.key]:
    IssuedDocumentsApi.uploadIssuedDocumentAttachment,
  [IssuedEInvoicesApi.getEInvoiceRejectionReason.key]:
    IssuedEInvoicesApi.getEInvoiceRejectionReason,
  ...
  [ReceivedDocumentsApi.deleteBinReceivedDocument.key]:
    ReceivedDocumentsApi.deleteBinReceivedDocument,
  [ReceivedDocumentsApi.deleteReceivedDocument.key]: ReceivedDocumentsApi.deleteReceivedDocument,
  [ReceivedDocumentsApi.deleteReceivedDocumentAttachment.key]:
    ReceivedDocumentsApi.deleteReceivedDocumentAttachment,
  [ReceivedDocumentsApi.getBinReceivedDocument.key]: ReceivedDocumentsApi.getBinReceivedDocument,
  [ReceivedDocumentsApi.getExistingReceivedDocumentTotals.key]:
    ReceivedDocumentsApi.getExistingReceivedDocumentTotals,
  [ReceivedDocumentsApi.getNewReceivedDocumentTotals.key]:
    ReceivedDocumentsApi.getNewReceivedDocumentTotals,
  [ReceivedDocumentsApi.getPendingReceivedDocument.key]:
    ReceivedDocumentsApi.getPendingReceivedDocument,
  [ReceivedDocumentsApi.getReceivedDocument.key]: ReceivedDocumentsApi.getReceivedDocument,
  [ReceivedDocumentsApi.getReceivedDocumentPreCreateInfo.key]:
    ReceivedDocumentsApi.getReceivedDocumentPreCreateInfo,
  [ReceivedDocumentsApi.listBinReceivedDocuments.key]:
    ReceivedDocumentsApi.listBinReceivedDocuments,
  [ReceivedDocumentsApi.listPendingReceivedDocuments.key]:
    ReceivedDocumentsApi.listPendingReceivedDocuments,
  ...
  [ReceivedDocumentsApi.recoverBinReceivedDocument.key]:
    ReceivedDocumentsApi.recoverBinReceivedDocument,
  [ReceivedDocumentsApi.uploadReceivedDocumentAttachment.key]:
    ReceivedDocumentsApi.uploadReceivedDocumentAttachment,
...
module.exports = {
  searchActions: () =>
    Object.entries(actions).reduce(
      (actions, [key, value]) =>
        isSearchAction(key) && hasSearchRequisites(value)
          ? { ...actions, [key]: searchMiddleware(value) }
          : actions,
      {}
    ),
  createActions: () =>
    Object.entries(actions).reduce(
      (actions, [key, value]) =>
        isCreateAction(key) ? { ...actions, [key]: createMiddleware(value) } : actions,
      {}
    ),
  triggers: () =>
    Object.entries(actions).reduce(
      (actions, [key, value]) =>
        isTrigger(key) ? { ...actions, [key]: triggerMiddleware(value) } : actions,
      {}
    ),
};
