...
module.exports = {
    getPriceListItems: {
        ...
        operation: {
            ...
            outputFields: [
                ...GetPriceListItemsResponse.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://api-v2.fattureincloud.it/c/{company_id}/price_lists/{price_list_id}/items'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getPriceListItems', response.json);
                    return results;
                })
            },
    ...
    getPriceLists: {
        ...
        operation: {
            ...
            outputFields: [
                ...ListPriceListsResponse.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://api-v2.fattureincloud.it/c/{company_id}/price_lists'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getPriceLists', response.json);
                    return results;
                })
            },
