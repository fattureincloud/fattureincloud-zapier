...
module.exports = {
  createF24: {
    ...
    operation: {
      ...
      outputFields: [...CreateF24Response.fields('', false)],
  ...
  deleteF24Attachment: {
    ...
    operation: {
      ...
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/taxes/{document_id}/attachment'
          ),
          method: 'DELETE',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  getF24: {
    ...
    operation: {
      ...
      outputFields: [...GetF24Response.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/taxes/{document_id}'
  ...
  listF24: {
    ...
    operation: {
      ...
      outputFields: [...ListF24Response.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters('https://api-v2.fattureincloud.it/c/{company_id}/taxes'),
          method: 'GET',
  ...
  modifyF24: {
    ...
    operation: {
      ...
      outputFields: [...ModifyF24Response.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/taxes/{document_id}'
  ...
  uploadF24Attachment: {
    ...
    operation: {
      ...
      outputFields: [...UploadF24AttachmentResponse.fields('', false)],
      perform: async (z, bundle) => {
