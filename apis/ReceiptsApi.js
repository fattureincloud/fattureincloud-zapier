...
module.exports = {
  createReceipt: {
    ...
    operation: {
      ...
      outputFields: [...CreateReceiptResponse.fields('', false)],
  ...
  deleteReceipt: {
    ...
    operation: {
      ...
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/receipts/{document_id}'
          ),
          method: 'DELETE',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  getReceipt: {
    ...
    operation: {
      ...
      outputFields: [...GetReceiptResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/receipts/{document_id}'
  ...
  getReceiptPreCreateInfo: {
    ...
    operation: {
      ...
      outputFields: [...GetReceiptPreCreateInfoResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
    ...
    operation: {
      inputFields: [
        ...
        },
        {
          ...
          type: 'string',
          required: true,
          choices: ['sales_receipt', 'till_receipt'],
        },
        {
          key: 'year',
      ...
      outputFields: [...GetReceiptsMonthlyTotalsResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/receipts/monthly_totals'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listReceipts: {
    ...
    operation: {
      ...
      outputFields: [...ListReceiptsResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/receipts'
  ...
  modifyReceipt: {
    ...
    operation: {
      ...
      outputFields: [...ModifyReceiptResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/receipts/{document_id}'
