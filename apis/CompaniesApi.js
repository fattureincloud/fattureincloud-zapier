...
module.exports = {
  getCompanyInfo: {
    ...
    operation: {
      ...
      outputFields: [...GetCompanyInfoResponse.fields('', false)],
    ...
    operation: {
      inputFields: [
        ...
        },
        {
          ...
          type: 'string',
          required: true,
          choices: ['clients', 'suppliers', 'products', 'documents'],
        },
      ],
      outputFields: [...GetCompanyPlanUsageResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/company/plan_usage'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
