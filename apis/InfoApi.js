...
module.exports = {
  listArchiveCategories: {
    ...
    operation: {
      ...
      outputFields: [...ListArchiveCategoriesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/archive_categories'
          ),
          method: 'GET',
  ...
  listCities: {
    ...
    operation: {
      ...
      outputFields: [...ListCitiesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
        ...
        return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
          response.throwForStatus();
          const results = utils.responseOptionsMiddleware(z, bundle, 'listCities', response.json);
          return results;
        });
      },
  ...
  listCostCenters: {
    ...
    operation: {
      ...
      outputFields: [...ListCostCentersResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/cost_centers'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listCountries: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListCountriesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
  ...
  listCurrencies: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListCurrenciesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
      ...
      inputFields: [
        {
          ...
          type: 'string',
          choices: ['all', 'standard', 'delivery_note', 'accompanying_invoice'],
        },
        {
          key: 'by_type',
          label:
  ...
  listDeliveryNotesDefaultCausals: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListDeliveryNotesDefaultCausalsResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
  ...
  listDetailedCountries: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListDetailedCountriesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/info/detailed_countries'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listLanguages: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListLanguagesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
  ...
  listPaymentAccounts: {
    ...
    operation: {
      ...
      outputFields: [...ListPaymentAccountsResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/payment_accounts'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listPaymentMethods: {
    ...
    operation: {
      ...
      outputFields: [...ListPaymentMethodsResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/payment_methods'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
    ...
    operation: {
      inputFields: [
        ...
        },
        {
          ...
          type: 'string',
          required: true,
          choices: ['products', 'issued_documents', 'received_documents'],
        },
      ],
      outputFields: [...ListProductCategoriesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/product_categories'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listReceivedDocumentCategories: {
    ...
    operation: {
      ...
      outputFields: [...ListReceivedDocumentCategoriesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/received_document_categories'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listRevenueCenters: {
    ...
    operation: {
      ...
      outputFields: [...ListRevenueCentersResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/revenue_centers'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
  ...
  listUnitsOfMeasure: {
    ...
    operation: {
      inputFields: [],
      outputFields: [...ListUnitsOfMeasureResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
  ...
  listVatTypes: {
    ...
    operation: {
      ...
      outputFields: [...ListVatTypesResponse.fields('', false)],
      perform: async (z, bundle) => {
        const options = {
          url: utils.replacePathParameters(
            'https://api-v2.fattureincloud.it/c/{company_id}/info/vat_types'
          ),
          method: 'GET',
          removeMissingValuesFrom: { params: true, body: true },
          headers: {
        ...
        return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
          response.throwForStatus();
          const results = utils.responseOptionsMiddleware(z, bundle, 'listVatTypes', response.json);
          return results;
        });
      },
