module.exports = {
  ...
  CreatePaymentMethodResponseSample: {
    data: {
      ...
      is_default: true,
      type: 'standard',
      details: [{ title: 'Banca', description: 'Sao Paulo' }],
      default_payment_account: { id: 12345, name: 'conto banca SP' },
    },
  },
  ...
  GetTaxProfileResponseSample: {
    data: {
      ...
      default_vat: {
        ...
        ei_type: 2.2,
        ei_description:
          'Non soggetta art. 1\\/54-89 L. 190\\/2014 e succ. modifiche\\/integrazioni',
        editable: false,
        is_disabled: false,
        default: true,
      },
