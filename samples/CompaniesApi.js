module.exports = {
  GetCompanyInfoResponseSample: {
    data: {
      ...
      plan_info: {
        limits: { clients: 5000, suppliers: 5000, products: 5000, documents: 3000 },
        functions: {
        ...
        functions_status: { ts_digital: { active: true }, ts_pay: { active: true } },
      },
      is_accountant: true,
      accountant_id: 12345,
  ...
  GetCompanyPlanUsageResponseSample: { data: { limit: 3000, usage: 100 } },
};
